...
(function ($) {
    ...
    Selectpicker.prototype = {
        ...
        init: function () {
            ...
            this.$doneButton = this.$menu.children('.bs-donebutton');
            ...
            if (this.options.size === 'auto') {
                var getSize = function () {
                    ...
                    if (that.$newElement.hasClass('dropup')) {
                        ...
                        $doneButton.prependTo($menu);
                    } else {
                        $doneButton.appendTo($menu);
                    }
        ...
        clickListener: function () {
            ...
            this.$doneButton.on('click', function (e) {
                if (!that.options.doneButtonClick) return;

                if (that.options.doneButtonClick() === false) {
                    e.stopPropagation();
                }
            });
